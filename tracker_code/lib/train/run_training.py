...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    if distill:
        ...
        expr_module = importlib.import_module('lib.train.train_script_step2')   # 20231116
...
#     parser.add_argument('--config_prv', type=str, default='baseline_step2', help='yaml configure file name')
